...
public class TestSupport {
    ...
    public static final String WEATHER_API_ENDPOINT = "/v1/api/weather";
    ...
    public Instant getCurrentInstant() {
        String instantExpected = "2023-04-30T10:15:30Z";
    ...
    public Weather getSavedWeather(String responseLocalTime) {
        return new Weather(
                "id",
                requestedCity,
                "Amsterdam",
    ...
    public Weather getSavdWeather(String responseLocalTime) {
        return new Weather(
                requestedCity,
                "Amsterdam",
                "Netherlands",
